...
export function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await fetch(encodeURI(`/proxy/create_user`), {
        method: 'POST',
        headers: {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-900 to-blue-400 text-black">
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="first_name" className="font-semibold text-blue-900">
            Imię
          </label>
          <input
            id="first_name"
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="last_name" className="font-semibold text-blue-900">
            Nazwisko
          </label>
          <input
            id="last_name"
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="tags" className="font-semibold text-blue-900">
            Tagi (opcjonalnie)
          </label>
          <input
            id="tags"
